...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-05 23:18`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b364fbf1-6f5e-469c-b9f9-05d30f0ee618.git
$ cd b364fbf1-6f5e-469c-b9f9-05d30f0ee618
```
